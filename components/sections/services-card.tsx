...
const serviceData = [
	{
		...
		description:
			"I craft scalable full-stack web apps using modern frameworks like React, Next.js, etc. From frontend design to backend logic, I turn ideas into fully functional products...",
		link: "",
	},
	{
		icon: <Cloud />,
		title: "DevOps",
		description:
			"I automate deployment pipelines and manage cloud infrastructure to boost development speed. Ensuring reliability, scalability, and security across the entire software lifecycle...",
		link: "",
	},
];
