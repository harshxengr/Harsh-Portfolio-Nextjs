...
const Projects = () => {
	...
	return (
		...
		>
			<div className="absolute inset-0 bg-linear-to-b from-transparent via-accent/10 to-transparent dark:via-accent/20" />
			...
			<div className="relative max-w-7xl mx-auto md:px-4 lg:px-8">
				...
				>
					...
					>
						Here are some cool things I&apos;ve built recently. Each project
						taught me something new and pushed my skills further.
					</motion.p>
				</motion.div>
				...
				>
					{projectsData.map(
						({ title, description, bgImage, liveLink, githubLink }) => (
							<motion.div
								key={title}
							...
							>
								<div className="relative h-full rounded-2xl bg-card border border-border overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-primary/20">
									<div className="relative overflow-hidden aspect-video bg-linear-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900">
										<motion.div
									...
									<div className="absolute top-0 right-0 w-20 h-20 bg-linear-to-br from-primary/10 to-transparent rounded-bl-full opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
								</div>
							</motion.div>
						),
					)}
