		...
		<div className="flex flex-col gap-24 md:gap-32 justify-between max-w-7xl mx-auto mb-16">
			<Tilt rotationFactor={8} isRevese>
				...
				>
					...
					<div
						className="absolute -bottom-24 -left-24 w-96 h-96 bg-accent/10 rounded-full blur-3xl animate-pulse"
					...
					<div className="relative z-10">
						...
						>
							<h2 className="text-4xl md:text-5xl font-bold bg-linear-to-r from-foreground via-primary to-foreground bg-clip-text text-transparent">
								About Me
							</h2>
							<div className="mt-4 h-1 w-24 mx-auto bg-linear-to-r from-transparent via-primary to-transparent rounded-full" />
						</motion.div>
						...
						>
							<div className="prose prose-lg dark:prose-invert max-w-none">
								<p className="text-base md:text-lg leading-relaxed text-muted-foreground">
									...
									with great passion for coding & building scalable web apps
									with clean UI and robust backend systems. With{" "}
									<span className="text-foreground font-semibold">
										DevOps expertise
									</span>
									, I automate deployments, manage cloud infrastructure, and
									streamline CI/CD workflows. I blend clean code with real-world
									problem-solving to deliver high-impact, performance-driven
									solutions.
								</p>
							</div>
