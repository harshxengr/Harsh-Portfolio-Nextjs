...
const TechStack = () => {
	...
	return (
		<section
			id="skills"
			className="relative flex flex-col gap-16 w-full py-16 md:py-24 overflow-hidden"
		>
			<div className="absolute inset-0 bg-linear-to-b from-transparent via-primary/10 to-transparent dark:via-primary/20" />
